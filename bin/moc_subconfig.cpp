...
namespace {
struct qt_meta_tag_ZN9SubConfigE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9SubConfigE = QtMocHelpers::stringData(
    "SubConfig"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9SubConfigE[] = {
...
Q_CONSTINIT const QMetaObject SubConfig::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9SubConfigE.offsetsAndSizes,
    qt_meta_data_ZN9SubConfigE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9SubConfigE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<SubConfig *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *SubConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9SubConfigE.stringdata0))
