...
namespace {
struct qt_meta_tag_ZN12CustomSliderE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12CustomSliderE = QtMocHelpers::stringData(
    "CustomSlider"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CustomSliderE[] = {
...
Q_CONSTINIT const QMetaObject CustomSlider::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CustomSliderE.offsetsAndSizes,
    qt_meta_data_ZN12CustomSliderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CustomSliderE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CustomSliderE.stringdata0))
