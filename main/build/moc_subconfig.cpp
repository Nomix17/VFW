...
namespace {
struct qt_meta_stringdata_SubConfig_t {
    uint offsetsAndSizes[2];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SubConfig_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SubConfig_t qt_meta_stringdata_SubConfig = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SubConfig[] = {
...
Q_CONSTINIT const QMetaObject SubConfig::staticMetaObject = { {
    ...
    qt_meta_stringdata_SubConfig.offsetsAndSizes,
    qt_meta_data_SubConfig,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SubConfig_t,
        // Q_OBJECT / Q_GADGET
...
void *SubConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SubConfig.stringdata0))
